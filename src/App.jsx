...
//       let completedOn = date + '-' + month + '-' + year + ' ' + h + ':' + m + ':' + s;
...
//           <div className="todo-input-item">
//             <label>Title</label>
//             <input type="text" value={newTitel} onChange={(e)=>setNewTitel(e.target.value)} placeholder="What's the task title.?" />
//           </div>
...
//           <div className="todo-input-item">
//             <button type="button" onClick={handelAddTodo} className="primaryBtn">Add</button>
//           </div>
//         </div>
...
//               <BsCheckLg className='check-icon' onClick={()=>handelDeleteCompletedTodo (index)} title='Complete' />
//             </div>
...
//             <div>
//               <AiOutlineDelete className='icon' onClick={()=>handelDeleteTodo(index)} title='Delete' />
//               {/* <BsCheckLg className='check-icon' onClick={()=>handelComplete(index)} title='Complete' /> */}
//             </div>
